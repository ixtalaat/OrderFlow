...
public class ActivateDeactivateCommandHandlerTests
{
    ...
    public async Task Activate_Should_Return_NotFound_When_Customer_Missing()
    {
        ...
        var handler = new ActivateCustomerCommandHandler(_customerRepository, _unitOfWork, _auditService);
    ...
    public async Task Deactivate_Should_Return_NotFound_When_Customer_Missing()
    {
        ...
        var handler = new DeactivateCustomerCommandHandler(_customerRepository, _unitOfWork, _identityService, _auditService);
