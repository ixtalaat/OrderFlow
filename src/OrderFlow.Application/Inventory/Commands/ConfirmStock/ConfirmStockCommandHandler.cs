...
public sealed class ConfirmStockCommandHandler(IInventoryRepository inventories, IUnitOfWork unitOfWork, ILowStockMonitor lowStock, ILogger<ConfirmStockCommandHandler> logger) : IRequestHandler<ConfirmStockCommand, Result<InventoryResponse>>
{
