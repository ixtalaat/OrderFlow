...
public interface IPricingRuleRepository
{
    ...
    Task<IReadOnlyList<PricingRule>> GetActiveAsync(IReadOnlyCollection<int> productIds, CustomerTier tier, DateTime utcNow, CancellationToken cancellationToken = default);
